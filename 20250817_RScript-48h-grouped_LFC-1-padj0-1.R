...
#### Samples seperated by chemokine and stimulation for time point 48 h
...
##Subset for time point 48h 
counts_data <- counts_data[, c("DE96NGSUKBR136767", "DE69NGSUKBR136768", "DE42NGSUKBR136769",
                               "DE15NGSUKBR136770", "DE85NGSUKBR136771", "DE58NGSUKBR136772",
                               "DE31NGSUKBR136773", "DE04NGSUKBR136774", "DE74NGSUKBR136775", 
                               "DE47NGSUKBR136776", "DE20NGSUKBR136777", "DE90NGSUKBR136778",
                               "DE63NGSUKBR136779", "DE36NGSUKBR136780", "DE09NGSUKBR136781",
                               "DE79NGSUKBR136782", "DE52NGSUKBR136783", "DE25NGSUKBR136784")]


head(counts_data)


## read in sample info for time point 48h 

colData <- read.csv('sample_info_48h.csv', sep = ";", row.names = 1)
head(colData)
str(colData)
...
ggsave("combined_boxplots_48h.png", plot = combined_plot, width = 10, height = 6)
...
png("DESeq2_dispersion_plot_48h.png", width = 400, height = 300)
...
png("sample_distance_heatmap_48h.png", width = 800, height = 600)
pheatmap(
  sample_dist_matrix,
...
# Save the final plot
ggsave("PCA_plot_48h.png", plot = PCA, width = 8, height = 4, dpi = 300)
...
# Save the final plot
ggsave("CD11c_plot_48h.png", plot = CD11c, width = 6, height = 4, dpi = 300)
...
# Save the final plot
ggsave("MHCII_plot_48h.png", plot = MHCII, width = 6, height = 4, dpi = 300)
...
# Save the final plot
ggsave("CD80_plot_48h.png", plot = CD80, width = 6, height = 4, dpi = 300)
...
# Save the final plot
ggsave("CD86_plot_48h.png", plot = CD86, width = 6, height = 4, dpi = 300)
...
# Save the final plot
ggsave("CCR7_plot_48h.png", plot = CCR7, width = 6, height = 4, dpi = 300)
...
write.csv(results_cpg, file = "CpG-Chemokine-no-yes_48h_result-all.csv", row.names = F)
write.csv(results_ifn, file = "IFN-Chemokine-no-yes_48h_result-all.csv", row.names = F)
write.csv(results_cpg_ifn, file = "CpG-IFN-Chemokine-no-yes_48h_result-all.csv", row.names = F)
...
png("Histogramm-CpG_48h-padj.png", width = 650, height = 450)
...
png("Histogramm-IFN_48h-padj.png", width = 650, height = 450)
par(mar = c(5.1, 6.1, 5.1, 2.1))
...
png("Histogramm-CpG_IFN_48h-padj.png", width = 650, height = 450)
par(mar = c(5.1, 6.1, 5.1, 2.1))
...
write.csv(significant_cpg, file = "CpG-chemokine_no_yes_sig_48h.csv", row.names = F)
write.csv(significant_ifn, file = "IFN-chemokine_no_yes_sig_48h.csv", row.names = F)
write.csv(significant_cpg_ifn, file = "CpG-IFN-chemokine_no_yes_sig_48h.csv", row.names = F)
...
png("Heatmap_all_significant_CpG.png", width = 350, height = 300) 
pheatmap(
  mat = reordered_cpg,
  scale = "row",
...
png("Heatmap_all_significant_IFN.png", width = 350, height = 1500) 
pheatmap(
  mat = reordered_ifn,
  scale = "row",
...
png("Heatmap_all_significant_CpG_IFN.png", width = 350, height = 400) 
pheatmap(
...
png("Heatmap_top50_48h_IFN.png", width = 350, height = 500) 
pheatmap(
  mat = reordered_ifn,
  scale = "row",
  annotation_col = annot_ifn,
...
##### MA plot for CpG
png("plotMA-CpG_48h.png", width = 600, height = 400) 
...
png("plotMA-CpG_48h-background-corr.png", width = 600, height = 400)
...
png("plotMA-IFN_48h.png", width = 600, height = 400) 
...
# Use the corrected object to create the plot
png("plotMA-IFN_48h-background-corr.png", width = 600, height = 400)
par(mar = c(5, 6, 4, 2) + 0.1)
...
png("plotMA-CpG_IFN_48h.png", width = 600, height = 400) 
...
# Use the corrected object to create the plot
png("plotMA-CpG-IFN_48h-background-corr.png", width = 600, height = 400)
par(mar = c(5, 6, 4, 2) + 0.1)
...
png("Volcano-CpG_48h-padj.png", width = 630, height = 420)
...
plot(results_cpg$log2FoldChange, -log10(results_cpg$padj),  
     ...
     cex.main = 2.5,
     cex.axis = 1.5,
     xlim = c(-30, 30),  # Set x-axis range from -40 to 40
     ylim = c(0, 15)     # Set y-axis range from 0 to 12
)
...
png("Volcano-IFN_48h-padj.png", width = 630, height = 420)
par(mar = c(5, 5, 5, 13))  # Increase right margin (last value)
...
png("Volcano-CpG-IFN_48h-padj.png", width = 630, height = 420)
...
perform_and_plot_go <- function(gene_list, ontology_type, direction_label, file_suffix, results_obj_ensembl, universe_genes_ensembl) {
  ...
  file_name <- paste0("GO-term_CpG_48h_", direction_label, "-", ontology_type, file_suffix, ".csv")
  ...
  plot_file_name <- paste0("GO-dotplot_CpG_48h_", direction_label, "-", ontology_type, file_suffix, ".png")
  
  png(plot_file_name, width = 550, height = 250)
...
perform_and_plot_go <- function(gene_list, ontology_type, direction_label, file_suffix, results_obj_ensembl, universe_genes_ensembl) {
  ...
  # Save result as csv file
  file_name <- paste0("GO-term_IFN_48h_", direction_label, "-", ontology_type, file_suffix, ".csv")
  write.csv(go_results@result, file = file_name, row.names = F)
  message(paste("Saved GO results to", file_name))
  ...
  # Plot result
  plot_title <- paste("GO Enrichment of", direction_label, "genes -", ontology_type)
  plot_file_name <- paste0("GO-dotplot_IFN_48h_", direction_label, "-", ontology_type, file_suffix, ".png")
...
perform_and_plot_go <- function(gene_list, ontology_type, direction_label, file_suffix, results_obj_ensembl, universe_genes_ensembl) {
  ...
  # Save result as csv file
  file_name <- paste0("GO-term_Cpg-IFN_48h_", direction_label, "-", ontology_type, file_suffix, ".csv")
  write.csv(go_results@result, file = file_name, row.names = F)
  message(paste("Saved GO results to", file_name))
  ...
  # Plot result
  plot_title <- paste("GO Enrichment of", direction_label, "genes -", ontology_type)
  plot_file_name <- paste0("GO-dotplot_CpG-IFN_48h_", direction_label, "-", ontology_type, file_suffix, ".png")
  
  png(plot_file_name, width = 600, height = 800)
...
write.csv(gsea_results@result, file = "GSEA_GO_results_CpG_48h.csv", row.names = FALSE)
print("Full GO GSEA results table saved to 'GSEA_GO_results_CpG_48h.csv'")
...
# --- Step 4: Save and Visualize Results with ggplot2 ---
# Save the full results table
write.csv(gsea_results_hallmark@result, file = "GSEA_hallmark_results_CpG_48h.csv", row.names = FALSE)
print("Full GSEA results table saved to 'GSEA_hallmark_results_CpG_48h.csv'")
...
# --- Step 4: Save and Visualize Results with ggplot2 ---
# Save the full results table
write.csv(gsea_results_c7@result, file = "GSEA_C7_results_CpG_48h.csv", row.names = FALSE)
print("Full GSEA C7 results table saved to 'GSEA_C7_results_CpG_48h.csv'")
...
# --- Step 4: Save and Visualize Results with ggplot2 ---
# Save the full results table
write.csv(gsea_results_apoptosis@result, file = "GSEA_apoptosis_results_CpG_48h.csv", row.names = FALSE)
print("Full GSEA Apoptosis results table saved to 'GSEA_apoptosis_results_CpG_48h.csv'")
...
# Save the full results table
write.csv(tf_enrichment@result, file = "TFT_results_CpG_48h.csv", row.names = FALSE)
print("Full TFT enrichment results table saved to 'TFT_results_CpG_48h.csv'")
...
write.csv(gsea_results_ifn@result, file = "GSEA_GO_results_IFN_48h.csv", row.names = FALSE)
print("Full GO GSEA results table saved to 'GSEA_GO_results_IFN_48h.csv'")

if (nrow(gsea_results_ifn@result) > 0) {
  plot_data <- gsea_results_ifn@result
  plot_data$Description <- stringr::str_wrap(plot_data$Description, width = 40)
  
  png("GSEA_GO_dotplot_IFN_48h.png", width = 400, height = 300)
  p1 <- ggplot(plot_data, aes(
    x = -log10(p.adjust),
    y = reorder(Description, -log10(p.adjust)),
    size = setSize,
  ...
  png("GSEA_GO_enrichment_plot_ifn_48h.png", width = 800, height = 600)
...
head(gsea_results_ifn@result)
summary(gsea_results_ifn@result$p.adjust)

# Find the ID of the top enriched pathway from the results table
top_pathway_id <- gsea_results_ifn@result$ID[1]
...
leading_edge_genes <- gsea_results_ifn@result$core_enrichment[gsea_results_ifn@result$ID == top_pathway_id]
...
write.csv(gsea_results_hallmark_ifn@result, file = "GSEA_hallmark_results_IFN_48h.csv", row.names = FALSE)
print("Full GSEA Hallmark results table saved to 'GSEA_hallmark_results_IFN_48h.csv'")
...
write.csv(gsea_results_c7_ifn@result, file = "GSEA_C7_results_IFN_48h.csv", row.names = FALSE)
print("Full GSEA C7 results table saved to 'GSEA_C7_results_IFN_48h.csv'")

if (nrow(gsea_results_c7_ifn@result) > 0) {
  plot_data <- gsea_results_c7_ifn@result
  plot_data$Description <- stringr::str_wrap(plot_data$Description, width = 40)
  
  png("GSEA_C7_dotplot_IFN_48h.png", width = 600, height = 500)
  p1 <- ggplot(plot_data, aes(
    x = -log10(p.adjust),
    y = reorder(Description, -log10(p.adjust)),
    size = setSize,
...
write.csv(gsea_results_apoptosis_ifn@result, file = "GSEA_apoptosis_results_IFN_48h.csv", row.names = FALSE)
print("Full GSEA Apoptosis results table saved to 'GSEA_apoptosis_results_IFN_48h.csv'")
...
write.csv(tf_enrichment_ifn@result, file = "TFT_results_IFN_48h.csv", row.names = FALSE)
print("Full TFT enrichment results table saved to 'TFT_results_IFN_48h.csv'")
...
write.csv(gsea_results_cpg_ifn@result, file = "GSEA_GO_results_CpG_IFN_48h.csv", row.names = FALSE)
print("Full GO GSEA results table saved to 'GSEA_GO_results_CpG_IFN_48h.csv'")
...
write.csv(gsea_results_hallmark_cpg_ifn@result, file = "GSEA_hallmark_results_CpG_IFN_48h.csv", row.names = FALSE)
print("Full GSEA Hallmark results table saved to 'GSEA_hallmark_results_CpG_IFN_48h.csv'")
...
write.csv(gsea_results_c7_cpg_ifn@result, file = "GSEA_C7_results_CpG_IFN_48h.csv", row.names = FALSE)
print("Full GSEA C7 results table saved to 'GSEA_C7_results_CpG_IFN_48h.csv'")

if (nrow(gsea_results_c7_cpg_ifn@result) > 0) {
  plot_data <- gsea_results_c7_cpg_ifn@result
  plot_data$Description <- stringr::str_wrap(plot_data$Description, width = 40)
  
  png("GSEA_C7_dotplot_CpG_IFN_48h.png", width = 600, height = 500)
  p1 <- ggplot(plot_data, aes(
    x = -log10(p.adjust),
    y = reorder(Description, -log10(p.adjust)),
    size = setSize,
...
write.csv(gsea_results_apoptosis_cpg_ifn@result, file = "GSEA_apoptosis_results_CpG_IFN_48h.csv", row.names = FALSE)
print("Full GSEA Apoptosis results table saved to 'GSEA_apoptosis_results_CpG_IFN_48h.csv'")
...
write.csv(tf_enrichment_cpg_ifn@result, file = "TFT_results_CpG_IFN_48h.csv", row.names = FALSE)
print("Full TFT enrichment results table saved to 'TFT_results_CpG_IFN_48h.csv'")
...
# Assuming you want to plot the top 20 pathways from the camera results
camera_results_top20 <- head(camera_results_ifn, 20)

sum(camera_results_ifn$FDR < 0.05)

camera_results_top20 <- head(camera_results_ifn, 7)
...
camera_results_top20 <- head(camera_results_cpg_ifn, 9)
